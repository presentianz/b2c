...
class ResettingController extends BaseController
{
    ...
    /**
     * @Route("/send-email", name="user_resetting_send-email") 
     * reset user password: submit form and send email
     */
    ...
    /**
     * @Route("/check-email", name="user_resetting_check-email")
     */
    ...
    /**
     * @Route("/reset", name="user_resetting_reset")
     * Reset user password
     */
